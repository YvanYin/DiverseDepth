If you cannot download data from CloudStor, you can try the following google drive links. Note that we only provide links for Part-in (collected from taskonomy) and Part-out (collected from DIML).
